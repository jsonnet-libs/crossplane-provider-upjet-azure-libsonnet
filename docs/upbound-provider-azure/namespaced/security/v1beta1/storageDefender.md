---
permalink: /upbound-provider-azure/namespaced/security/v1beta1/storageDefender/
---

# security.v1beta1.storageDefender
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withMalwareScanningOnUploadCapGbPerMonth(malwareScanningOnUploadCapGbPerMonth)`](#fn-specforproviderwithmalwarescanningonuploadcapgbpermonth)
    * [`fn withMalwareScanningOnUploadEnabled(malwareScanningOnUploadEnabled)`](#fn-specforproviderwithmalwarescanningonuploadenabled)
    * [`fn withOverrideSubscriptionSettingsEnabled(overrideSubscriptionSettingsEnabled)`](#fn-specforproviderwithoverridesubscriptionsettingsenabled)
    * [`fn withScanResultsEventGridTopicId(scanResultsEventGridTopicId)`](#fn-specforproviderwithscanresultseventgridtopicid)
    * [`fn withSensitiveDataDiscoveryEnabled(sensitiveDataDiscoveryEnabled)`](#fn-specforproviderwithsensitivedatadiscoveryenabled)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withMalwareScanningOnUploadCapGbPerMonth(malwareScanningOnUploadCapGbPerMonth)`](#fn-specinitproviderwithmalwarescanningonuploadcapgbpermonth)
    * [`fn withMalwareScanningOnUploadEnabled(malwareScanningOnUploadEnabled)`](#fn-specinitproviderwithmalwarescanningonuploadenabled)
    * [`fn withOverrideSubscriptionSettingsEnabled(overrideSubscriptionSettingsEnabled)`](#fn-specinitproviderwithoverridesubscriptionsettingsenabled)
    * [`fn withScanResultsEventGridTopicId(scanResultsEventGridTopicId)`](#fn-specinitproviderwithscanresultseventgridtopicid)
    * [`fn withSensitiveDataDiscoveryEnabled(sensitiveDataDiscoveryEnabled)`](#fn-specinitproviderwithsensitivedatadiscoveryenabled)
...
new returns an instance of StorageDefender
...
### fn spec.forProvider.withMalwareScanningOnUploadCapGbPerMonth

```ts
withMalwareScanningOnUploadCapGbPerMonth(malwareScanningOnUploadCapGbPerMonth)
```
...
### fn spec.forProvider.withMalwareScanningOnUploadEnabled

```ts
withMalwareScanningOnUploadEnabled(malwareScanningOnUploadEnabled)
```

"Whether On Upload malware scanning should be enabled. Defaults to false."

### fn spec.forProvider.withOverrideSubscriptionSettingsEnabled

```ts
withOverrideSubscriptionSettingsEnabled(overrideSubscriptionSettingsEnabled)
```
...
### fn spec.forProvider.withScanResultsEventGridTopicId

```ts
withScanResultsEventGridTopicId(scanResultsEventGridTopicId)
```
...
### fn spec.forProvider.withSensitiveDataDiscoveryEnabled

```ts
withSensitiveDataDiscoveryEnabled(sensitiveDataDiscoveryEnabled)
```
...
### fn spec.initProvider.withMalwareScanningOnUploadCapGbPerMonth
...
### fn spec.initProvider.withMalwareScanningOnUploadEnabled
...
### fn spec.initProvider.withOverrideSubscriptionSettingsEnabled
...
### fn spec.initProvider.withScanResultsEventGridTopicId
...
### fn spec.initProvider.withSensitiveDataDiscoveryEnabled
