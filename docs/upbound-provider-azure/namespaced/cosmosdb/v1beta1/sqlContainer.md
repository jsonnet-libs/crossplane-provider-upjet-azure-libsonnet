---
permalink: /upbound-provider-azure/namespaced/cosmosdb/v1beta1/sqlContainer/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPartitionKeyKind(partitionKeyKind)`](#fn-specforproviderwithpartitionkeykind)
    * [`fn withPartitionKeyPaths(partitionKeyPaths)`](#fn-specforproviderwithpartitionkeypaths)
    * [`fn withPartitionKeyPathsMixin(partitionKeyPaths)`](#fn-specforproviderwithpartitionkeypathsmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withPartitionKeyKind(partitionKeyKind)`](#fn-specinitproviderwithpartitionkeykind)
    * [`fn withPartitionKeyPaths(partitionKeyPaths)`](#fn-specinitproviderwithpartitionkeypaths)
    * [`fn withPartitionKeyPathsMixin(partitionKeyPaths)`](#fn-specinitproviderwithpartitionkeypathsmixin)
...
### fn spec.forProvider.withPartitionKeyKind

```ts
withPartitionKeyKind(partitionKeyKind)
```
...
### fn spec.forProvider.withPartitionKeyPaths

```ts
withPartitionKeyPaths(partitionKeyPaths)
```

"A list of partition key paths. Changing this forces a new resource to be created."

### fn spec.forProvider.withPartitionKeyPathsMixin

```ts
withPartitionKeyPathsMixin(partitionKeyPaths)
```
...
### fn spec.initProvider.withPartitionKeyKind
...
### fn spec.initProvider.withPartitionKeyPaths
...
### fn spec.initProvider.withPartitionKeyPathsMixin
