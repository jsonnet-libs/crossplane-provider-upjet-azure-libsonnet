---
permalink: /upbound-provider-azure/namespaced/dataprotection/v1beta1/backupInstanceBlobStorage/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withStorageAccountContainerNames(storageAccountContainerNames)`](#fn-specforproviderwithstorageaccountcontainernames)
    * [`fn withStorageAccountContainerNamesMixin(storageAccountContainerNames)`](#fn-specforproviderwithstorageaccountcontainernamesmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withStorageAccountContainerNames(storageAccountContainerNames)`](#fn-specinitproviderwithstorageaccountcontainernames)
    * [`fn withStorageAccountContainerNamesMixin(storageAccountContainerNames)`](#fn-specinitproviderwithstorageaccountcontainernamesmixin)
...
### fn spec.forProvider.withStorageAccountContainerNames

```ts
withStorageAccountContainerNames(storageAccountContainerNames)
```

"The list of the container names of the source Storage Account."

### fn spec.forProvider.withStorageAccountContainerNamesMixin

```ts
withStorageAccountContainerNamesMixin(storageAccountContainerNames)
```
...
### fn spec.initProvider.withStorageAccountContainerNames
...
### fn spec.initProvider.withStorageAccountContainerNamesMixin
