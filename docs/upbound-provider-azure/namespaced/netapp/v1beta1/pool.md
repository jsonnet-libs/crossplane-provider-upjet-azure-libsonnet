---
permalink: /upbound-provider-azure/namespaced/netapp/v1beta1/pool/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withCoolAccessEnabled(coolAccessEnabled)`](#fn-specforproviderwithcoolaccessenabled)
    * [`fn withCustomThroughputMibps(customThroughputMibps)`](#fn-specforproviderwithcustomthroughputmibps)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withCoolAccessEnabled(coolAccessEnabled)`](#fn-specinitproviderwithcoolaccessenabled)
    * [`fn withCustomThroughputMibps(customThroughputMibps)`](#fn-specinitproviderwithcustomthroughputmibps)
...
### fn spec.forProvider.withCoolAccessEnabled

```ts
withCoolAccessEnabled(coolAccessEnabled)
```

"Whether the NetApp Pool can hold cool access enabled volumes. Defaults to false."

### fn spec.forProvider.withCustomThroughputMibps

```ts
withCustomThroughputMibps(customThroughputMibps)
```
...
### fn spec.initProvider.withCoolAccessEnabled
...
### fn spec.initProvider.withCustomThroughputMibps
