---
permalink: /upbound-provider-azure/cluster/databricks/v1beta1/workspace/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withEnhancedSecurityCompliance(enhancedSecurityCompliance)`](#fn-specforproviderwithenhancedsecuritycompliance)
    * [`fn withEnhancedSecurityComplianceMixin(enhancedSecurityCompliance)`](#fn-specforproviderwithenhancedsecuritycompliancemixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withEnhancedSecurityCompliance(enhancedSecurityCompliance)`](#fn-specinitproviderwithenhancedsecuritycompliance)
    * [`fn withEnhancedSecurityComplianceMixin(enhancedSecurityCompliance)`](#fn-specinitproviderwithenhancedsecuritycompliancemixin)
...
### fn spec.forProvider.withEnhancedSecurityCompliance

```ts
withEnhancedSecurityCompliance(enhancedSecurityCompliance)
```

"An enhanced_security_compliance block as documented below. This feature is only valid if sku is set to premium."

### fn spec.forProvider.withEnhancedSecurityComplianceMixin

```ts
withEnhancedSecurityComplianceMixin(enhancedSecurityCompliance)
```
...
### fn spec.initProvider.withEnhancedSecurityCompliance
...
### fn spec.initProvider.withEnhancedSecurityComplianceMixin
