---
permalink: /upbound-provider-azure/cluster/loadtestservice/v1beta1/loadTest/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.encryption`](#obj-specforproviderencryption)
      * [`fn withKeyUrl(keyUrl)`](#fn-specforproviderencryptionwithkeyurl)
      * [`obj spec.forProvider.encryption.identity`](#obj-specforproviderencryptionidentity)
        * [`fn withIdentityId(identityId)`](#fn-specforproviderencryptionidentitywithidentityid)
        * [`fn withType(type)`](#fn-specforproviderencryptionidentitywithtype)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.encryption`](#obj-specinitproviderencryption)
      * [`fn withIdentity(identity)`](#fn-specinitproviderencryptionwithidentity)
      * [`fn withIdentityMixin(identity)`](#fn-specinitproviderencryptionwithidentitymixin)
      * [`fn withKeyUrl(keyUrl)`](#fn-specinitproviderencryptionwithkeyurl)
      * [`obj spec.initProvider.encryption.identity`](#obj-specinitproviderencryptionidentity)
        * [`fn withIdentityId(identityId)`](#fn-specinitproviderencryptionidentitywithidentityid)
        * [`fn withType(type)`](#fn-specinitproviderencryptionidentitywithtype)
...
### fn spec.forProvider.encryption.withKeyUrl
...
## obj spec.forProvider.encryption.identity

"An identity block as defined below. Changing this forces a new Load Test to be created."

### fn spec.forProvider.encryption.identity.withIdentityId
...
### fn spec.forProvider.encryption.identity.withType
...
### fn spec.initProvider.encryption.withIdentity
...
### fn spec.initProvider.encryption.withIdentityMixin
...
### fn spec.initProvider.encryption.withKeyUrl
...
## obj spec.initProvider.encryption.identity

"An identity block as defined below. Changing this forces a new Load Test to be created."

### fn spec.initProvider.encryption.identity.withIdentityId
...
### fn spec.initProvider.encryption.identity.withType
