---
permalink: /upbound-provider-azure/cluster/apimanagement/v1beta1/backend/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withCircuitBreakerRule(circuitBreakerRule)`](#fn-specforproviderwithcircuitbreakerrule)
    * [`fn withCircuitBreakerRuleMixin(circuitBreakerRule)`](#fn-specforproviderwithcircuitbreakerrulemixin)
    ...
    * [`obj spec.forProvider.circuitBreakerRule`](#obj-specforprovidercircuitbreakerrule)
      ...
      * [`fn withFailureCondition(failureCondition)`](#fn-specforprovidercircuitbreakerrulewithfailurecondition)
      * [`fn withFailureConditionMixin(failureCondition)`](#fn-specforprovidercircuitbreakerrulewithfailureconditionmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withCircuitBreakerRule(circuitBreakerRule)`](#fn-specinitproviderwithcircuitbreakerrule)
    * [`fn withCircuitBreakerRuleMixin(circuitBreakerRule)`](#fn-specinitproviderwithcircuitbreakerrulemixin)
    ...
    * [`obj spec.initProvider.circuitBreakerRule`](#obj-specinitprovidercircuitbreakerrule)
      ...
      * [`fn withFailureCondition(failureCondition)`](#fn-specinitprovidercircuitbreakerrulewithfailurecondition)
      * [`fn withFailureConditionMixin(failureCondition)`](#fn-specinitprovidercircuitbreakerrulewithfailureconditionmixin)
...
### fn spec.forProvider.withCircuitBreakerRule

```ts
withCircuitBreakerRule(circuitBreakerRule)
```

"A circuit_breaker_rule block as documented below."

### fn spec.forProvider.withCircuitBreakerRuleMixin

```ts
withCircuitBreakerRuleMixin(circuitBreakerRule)
```
...
### fn spec.forProvider.circuitBreakerRule.withFailureCondition
...
### fn spec.forProvider.circuitBreakerRule.withFailureConditionMixin

```ts
withFailureConditionMixin(failureCondition)
```
...
### fn spec.initProvider.withCircuitBreakerRule
...
### fn spec.initProvider.withCircuitBreakerRuleMixin
...
### fn spec.initProvider.circuitBreakerRule.withFailureCondition
...
### fn spec.initProvider.circuitBreakerRule.withFailureConditionMixin
