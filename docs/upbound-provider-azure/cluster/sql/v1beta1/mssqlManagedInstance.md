---
permalink: /upbound-provider-azure/cluster/sql/v1beta1/mssqlManagedInstance/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withAzureActiveDirectoryAdministrator(azureActiveDirectoryAdministrator)`](#fn-specforproviderwithazureactivedirectoryadministrator)
    * [`fn withAzureActiveDirectoryAdministratorMixin(azureActiveDirectoryAdministrator)`](#fn-specforproviderwithazureactivedirectoryadministratormixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withAzureActiveDirectoryAdministrator(azureActiveDirectoryAdministrator)`](#fn-specinitproviderwithazureactivedirectoryadministrator)
    * [`fn withAzureActiveDirectoryAdministratorMixin(azureActiveDirectoryAdministrator)`](#fn-specinitproviderwithazureactivedirectoryadministratormixin)
...
### fn spec.forProvider.withAzureActiveDirectoryAdministrator

```ts
withAzureActiveDirectoryAdministrator(azureActiveDirectoryAdministrator)
```

"An azure_active_directory_administrator block as defined below."

### fn spec.forProvider.withAzureActiveDirectoryAdministratorMixin

```ts
withAzureActiveDirectoryAdministratorMixin(azureActiveDirectoryAdministrator)
```
...
### fn spec.initProvider.withAzureActiveDirectoryAdministrator
...
### fn spec.initProvider.withAzureActiveDirectoryAdministratorMixin
