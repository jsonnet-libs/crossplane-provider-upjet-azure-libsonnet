  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        ...
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on the Databricks Access Connector. Possible values are SystemAssigned, UserAssigned, SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
