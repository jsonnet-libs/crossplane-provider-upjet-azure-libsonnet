{
  ...
  new(name): {
    apiVersion: 'datamigration.azure.m.upbound.io/v1beta1',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSourcePlatform':: d.fn(help='"The platform type of the migration source. Possible values are MongoDb, MySQL, PostgreSql, SQL and Unknown. Changing this forces a new resource to be created."', args=[d.arg(name='sourcePlatform', type=d.T.string)]),
      ...
      '#withTargetPlatform':: d.fn(help='"The platform type of the migration target. Possible values are AzureDbForMySql, AzureDbForPostgreSql, MongoDb, SQLDB, SQLMI and Unknown. Changing this forces a new resource to be created."', args=[d.arg(name='targetPlatform', type=d.T.string)]),
