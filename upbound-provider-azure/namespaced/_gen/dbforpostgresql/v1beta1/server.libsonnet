{
  ...
  spec: {
    ...
    forProvider: {
      '#administratorLoginPasswordSecretRef':: d.obj(help='"The Password associated with the administrator_login for the PostgreSQL Server."'),
      ...
      '#withAdministratorLoginPasswordWo':: d.fn(help='"The Password associated with the administrator_login for the PostgreSQL Server."', args=[d.arg(name='administratorLoginPasswordWo', type=d.T.string)]),
      withAdministratorLoginPasswordWo(administratorLoginPasswordWo): { spec+: { forProvider+: { administratorLoginPasswordWo: administratorLoginPasswordWo } } },
    ...
    initProvider: {
      ...
      '#withAdministratorLoginPasswordWo':: d.fn(help='"The Password associated with the administrator_login for the PostgreSQL Server."', args=[d.arg(name='administratorLoginPasswordWo', type=d.T.string)]),
      withAdministratorLoginPasswordWo(administratorLoginPasswordWo): { spec+: { initProvider+: { administratorLoginPasswordWo: administratorLoginPasswordWo } } },
      '#withAdministratorLoginPasswordWoVersion':: d.fn(help='"An integer value used to trigger an update for administrator_login_password_wo. This property should be incremented when updating administrator_login_password_wo."', args=[d.arg(name='administratorLoginPasswordWoVersion', type=d.T.number)]),
