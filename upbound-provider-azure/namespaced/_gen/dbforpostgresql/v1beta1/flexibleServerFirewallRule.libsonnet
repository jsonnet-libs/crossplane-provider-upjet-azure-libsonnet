{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEndIpAddress':: d.fn(help='"The IPv4 Address defining the end of the range of addresses associated with this PostgreSQL Flexible Server Firewall Rule."', args=[d.arg(name='endIpAddress', type=d.T.string)]),
      ...
      '#withStartIpAddress':: d.fn(help='"The IPv4 Address defining the start of the range of addresses associated with this PostgreSQL Flexible Server Firewall Rule."', args=[d.arg(name='startIpAddress', type=d.T.string)]),
