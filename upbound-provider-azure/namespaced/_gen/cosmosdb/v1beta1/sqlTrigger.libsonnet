  ...
  spec: {
    ...
    forProvider: {
      ...
      containerIdRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { containerIdRef+: { namespace: namespace } } } },
      },
      ...
      containerIdSelector: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { containerIdSelector+: { namespace: namespace } } } },
      },
