{
  ...
  '#':: d.pkg(name='workspaceSQLAADAdmin', url='', help='"WorkspaceSQLAADAdmin is the Schema for the WorkspaceSQLAADAdmins API. Manages Synapse Workspace SQL AAD Admin"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLogin':: d.fn(help='"The login name of the Azure AD SQL Administrator of this Synapse Workspace."', args=[d.arg(name='login', type=d.T.string)]),
      withLogin(login): { spec+: { forProvider+: { login: login } } },
      '#withObjectId':: d.fn(help='"The object id of the Azure AD SQL Administrator of this Synapse Workspace."', args=[d.arg(name='objectId', type=d.T.string)]),
      withObjectId(objectId): { spec+: { forProvider+: { objectId: objectId } } },
      '#withSynapseWorkspaceId':: d.fn(help='"The ID of the Synapse Workspace where the Azure AD SQL Administrator should be configured."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
      withSynapseWorkspaceId(synapseWorkspaceId): { spec+: { forProvider+: { synapseWorkspaceId: synapseWorkspaceId } } },
      '#withTenantId':: d.fn(help='"The tenant id of the Azure AD SQL Administrator of this Synapse Workspace."', args=[d.arg(name='tenantId', type=d.T.string)]),
