{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStorageAccountId':: d.fn(help='"The name of the Storage Account where the Storage Queue should be created."', args=[d.arg(name='storageAccountId', type=d.T.string)]),
      withStorageAccountId(storageAccountId): { spec+: { forProvider+: { storageAccountId: storageAccountId } } },
      '#withStorageAccountName':: d.fn(help='"The name of the Storage Account where the Storage Queue should be created. This property is deprecated in favour of storage_account_id."', args=[d.arg(name='storageAccountName', type=d.T.string)]),
