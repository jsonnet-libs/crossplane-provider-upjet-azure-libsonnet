{
  ...
  '#':: d.pkg(name='redisCacheAccessPolicy', url='', help='"RedisCacheAccessPolicy is the Schema for the RedisCacheAccessPolicys API. Manages a Redis Cache Access Policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of RedisCacheAccessPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cache.azure.m.upbound.io/v1beta1',
    kind: 'RedisCacheAccessPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RedisCacheAccessPolicySpec defines the desired state of RedisCacheAccessPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPermissions':: d.fn(help='"Permissions that are going to be assigned to this Redis Cache Access Policy."', args=[d.arg(name='permissions', type=d.T.string)]),
      withPermissions(permissions): { spec+: { forProvider+: { permissions: permissions } } },
      '#withRedisCacheId':: d.fn(help='"The ID of the Redis Cache. Changing this forces a new Redis Cache Access Policy to be created."', args=[d.arg(name='redisCacheId', type=d.T.string)]),
