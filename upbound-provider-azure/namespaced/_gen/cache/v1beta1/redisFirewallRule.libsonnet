  ...
  spec: {
    ...
    forProvider: {
      ...
      redisCacheNameRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { redisCacheNameRef+: { namespace: namespace } } } },
      },
      ...
      redisCacheNameSelector: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { redisCacheNameSelector+: { namespace: namespace } } } },
      },
