{
  ...
  new(name): {
    apiVersion: 'communication.azure.m.upbound.io/v1beta1',
    kind: 'Service',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDataLocation':: d.fn(help='"The location where the Communication service stores its data at rest. Possible values are Africa, Asia Pacific, Australia, Brazil, Canada, Europe, France, Germany, India, Japan, Korea, Norway, Switzerland, UAE, UK, usgov and United States. Defaults to United States. Changing this forces a new Communication Service to be created."', args=[d.arg(name='dataLocation', type=d.T.string)]),
