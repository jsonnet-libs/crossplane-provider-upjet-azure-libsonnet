{
  ...
  new(name): {
    apiVersion: 'powerbidedicated.azure.m.upbound.io/v1beta1',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSkuName':: d.fn(help="\"Sets the PowerBI Embedded's pricing level's SKU. Possible values include: A1, A2, A3, A4, A5, A6, A7 and A8.\"", args=[d.arg(name='skuName', type=d.T.string)]),
