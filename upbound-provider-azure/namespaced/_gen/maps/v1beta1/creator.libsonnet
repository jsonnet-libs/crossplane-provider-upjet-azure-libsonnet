  ...
  spec: {
    ...
    forProvider: {
      ...
      mapsAccountIdRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { mapsAccountIdRef+: { namespace: namespace } } } },
      },
      ...
      mapsAccountIdSelector: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { mapsAccountIdSelector+: { namespace: namespace } } } },
      },
