{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBgpRoutePropagationEnabled':: d.fn(help='"Boolean flag which controls propagation of routes learned by BGP on that route table. Defaults to true."', args=[d.arg(name='bgpRoutePropagationEnabled', type=d.T.boolean)]),
      withBgpRoutePropagationEnabled(bgpRoutePropagationEnabled): { spec+: { forProvider+: { bgpRoutePropagationEnabled: bgpRoutePropagationEnabled } } },
    ...
    initProvider: {
      ...
      '#withBgpRoutePropagationEnabled':: d.fn(help='"Boolean flag which controls propagation of routes learned by BGP on that route table. Defaults to true."', args=[d.arg(name='bgpRoutePropagationEnabled', type=d.T.boolean)]),
      withBgpRoutePropagationEnabled(bgpRoutePropagationEnabled): { spec+: { initProvider+: { bgpRoutePropagationEnabled: bgpRoutePropagationEnabled } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
