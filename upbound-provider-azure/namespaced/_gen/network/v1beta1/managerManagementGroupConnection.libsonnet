  ...
  spec: {
    ...
    initProvider: {
      ...
      networkManagerIdRef: {
        ...
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { networkManagerIdRef+: { namespace: namespace } } } },
      },
      '#networkManagerIdSelector':: d.obj(help='"Selector for a Manager in network to populate networkManagerId."'),
      networkManagerIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        ...
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { networkManagerIdSelector+: { namespace: namespace } } } },
      },
      '#withDescription':: d.fn(help='"A description of the Network Manager Management Group Connection."', args=[d.arg(name='description', type=d.T.string)]),
