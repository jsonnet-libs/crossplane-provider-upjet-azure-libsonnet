{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSku':: d.fn(help='"The SKU of the Azure Load Balancer. Accepted values are Basic, Standard and Gateway. Defaults to Standard. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
