{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCustomIpPrefixId':: d.fn(help='"The Custom IP Prefix ID associated with the Public IP Prefix. Changing this forces a new resource to be created."', args=[d.arg(name='customIpPrefixId', type=d.T.string)]),
      withCustomIpPrefixId(customIpPrefixId): { spec+: { forProvider+: { customIpPrefixId: customIpPrefixId } } },
    ...
    initProvider: {
      '#withCustomIpPrefixId':: d.fn(help='"The Custom IP Prefix ID associated with the Public IP Prefix. Changing this forces a new resource to be created."', args=[d.arg(name='customIpPrefixId', type=d.T.string)]),
      withCustomIpPrefixId(customIpPrefixId): { spec+: { initProvider+: { customIpPrefixId: customIpPrefixId } } },
      '#withIpVersion':: d.fn(help='"The IP Version to use, IPv6 or IPv4. Changing this forces a new resource to be created. Default is IPv4."', args=[d.arg(name='ipVersion', type=d.T.string)]),
