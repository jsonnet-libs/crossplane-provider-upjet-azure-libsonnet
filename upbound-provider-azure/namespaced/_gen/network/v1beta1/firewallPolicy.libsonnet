{
  ...
  spec: {
    ...
    forProvider: {
      ...
      tlsCertificate: {
        '#withKeyVaultSecretId':: d.fn(help='"The Secret Identifier (URI) of the certificate stored in Azure Key Vault, either as a secret or certificate."', args=[d.arg(name='keyVaultSecretId', type=d.T.string)]),
      ...
      '#withSku':: d.fn(help='"The SKU Tier of the Firewall Policy. Possible values are Standard, Premium and Basic. Defaults to Standard. Changing this forces a new Firewall Policy to be created."', args=[d.arg(name='sku', type=d.T.string)]),
