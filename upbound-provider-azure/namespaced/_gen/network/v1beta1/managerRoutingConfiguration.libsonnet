{
  ...
  '#':: d.pkg(name='managerRoutingConfiguration', url='', help='"ManagerRoutingConfiguration is the Schema for the ManagerRoutingConfigurations API. Manages a Network Manager Routing Configuration."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagerRoutingConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'network.azure.m.upbound.io/v1beta1',
    kind: 'ManagerRoutingConfiguration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ManagerRoutingConfigurationSpec defines the desired state of ManagerRoutingConfiguration"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the Network Manager Routing Configuration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withNetworkManagerId':: d.fn(help='"The ID of the Network Manager. Changing this forces a new Network Manager Routing Configuration to be created."', args=[d.arg(name='networkManagerId', type=d.T.string)]),
