{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAcceleratedNetworkingEnabled':: d.fn(help='"Should Accelerated Networking be enabled? Defaults to false."', args=[d.arg(name='acceleratedNetworkingEnabled', type=d.T.boolean)]),
      withAcceleratedNetworkingEnabled(acceleratedNetworkingEnabled): { spec+: { forProvider+: { acceleratedNetworkingEnabled: acceleratedNetworkingEnabled } } },
      ...
      '#withIpForwardingEnabled':: d.fn(help='"Should IP Forwarding be enabled? Defaults to false."', args=[d.arg(name='ipForwardingEnabled', type=d.T.boolean)]),
      withIpForwardingEnabled(ipForwardingEnabled): { spec+: { forProvider+: { ipForwardingEnabled: ipForwardingEnabled } } },
    ...
    initProvider: {
      ...
      '#withAcceleratedNetworkingEnabled':: d.fn(help='"Should Accelerated Networking be enabled? Defaults to false."', args=[d.arg(name='acceleratedNetworkingEnabled', type=d.T.boolean)]),
      withAcceleratedNetworkingEnabled(acceleratedNetworkingEnabled): { spec+: { initProvider+: { acceleratedNetworkingEnabled: acceleratedNetworkingEnabled } } },
      '#withAuxiliaryMode':: d.fn(help='"Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). This feature offers competitive performance in Connections Per Second (CPS) optimization, along with improvements to handling large amounts of simultaneous connections. Possible values are AcceleratedConnections, Floating, MaxConnections and None."', args=[d.arg(name='auxiliaryMode', type=d.T.string)]),
      ...
      '#withIpForwardingEnabled':: d.fn(help='"Should IP Forwarding be enabled? Defaults to false."', args=[d.arg(name='ipForwardingEnabled', type=d.T.boolean)]),
      withIpForwardingEnabled(ipForwardingEnabled): { spec+: { initProvider+: { ipForwardingEnabled: ipForwardingEnabled } } },
      '#withLocation':: d.fn(help='"The location where the Network Interface should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
