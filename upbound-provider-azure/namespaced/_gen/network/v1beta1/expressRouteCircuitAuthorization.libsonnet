  ...
  spec: {
    ...
    forProvider: {
      ...
      expressRouteCircuitNameRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { expressRouteCircuitNameRef+: { namespace: namespace } } } },
      },
      ...
      expressRouteCircuitNameSelector: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { expressRouteCircuitNameSelector+: { namespace: namespace } } } },
      },
