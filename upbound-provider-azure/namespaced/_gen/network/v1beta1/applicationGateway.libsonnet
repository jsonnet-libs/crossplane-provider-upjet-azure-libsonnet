  ...
  spec: {
    ...
    forProvider: {
      ...
      backendHttpSettings: {
        ...
        '#withDedicatedBackendConnectionEnabled':: d.fn(help='"Whether to use a dedicated backend connection. Defaults to false."', args=[d.arg(name='dedicatedBackendConnectionEnabled', type=d.T.boolean)]),
        withDedicatedBackendConnectionEnabled(dedicatedBackendConnectionEnabled): { dedicatedBackendConnectionEnabled: dedicatedBackendConnectionEnabled },
      ...
      customErrorConfiguration: {
        ...
        '#withStatusCode':: d.fn(help='"Status code of the application gateway customer error. Possible values are HttpStatus400, HttpStatus403, HttpStatus404, HttpStatus405, HttpStatus408, HttpStatus500, HttpStatus502, HttpStatus503 and HttpStatus504"', args=[d.arg(name='statusCode', type=d.T.string)]),
      ...
      frontendIpConfiguration: {
        ...
        publicIpAddressIdRef: {
          ...
          withNamespace(namespace): { publicIpAddressIdRef+: { namespace: namespace } },
        },
        ...
        publicIpAddressIdSelector: {
          ...
          withNamespace(namespace): { publicIpAddressIdSelector+: { namespace: namespace } },
        },
      ...
      probe: {
        ...
        '#withPort':: d.fn(help='"Custom port which will be used for probing the backend servers. The valid value ranges from 1 to 65535. In case not set, port from HTTP settings will be used. This property is valid for Basic, Standard_v2 and WAF_v2 only."', args=[d.arg(name='port', type=d.T.number)]),
        withPort(port): { port: port },
      ...
      '#rewriteRuleSet':: d.obj(help='"One or more rewrite_rule_set blocks as defined below. Only valid for v2 WAF and Standard SKUs."'),
      rewriteRuleSet: {
      ...
      sku: {
        '#withCapacity':: d.fn(help='"The Capacity of the SKU to use for this Application Gateway. When using a V1 SKU this value must be between 1 and 32, and 1 to 125 for a V2 SKU. When using a Basic SKU this property must be between 1 and 2. This property is optional if autoscale_configuration is set."', args=[d.arg(name='capacity', type=d.T.number)]),
        withCapacity(capacity): { spec+: { forProvider+: { sku+: { capacity: capacity } } } },
        '#withName':: d.fn(help='"The Name of the SKU to use for this Application Gateway. Possible values are Basic, Standard_Small, Standard_Medium, Standard_Large, Standard_v2, WAF_Large, WAF_Medium and WAF_v2."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { sku+: { name: name } } } },
        '#withTier':: d.fn(help='"The Tier of the SKU to use for this Application Gateway. Possible values are Basic, Standard_v2, and WAF_v2."', args=[d.arg(name='tier', type=d.T.string)]),
      ...
      sslCertificate: {
        ...
        '#withKeyVaultSecretId':: d.fn(help='"The Secret ID of the (base-64 encoded unencrypted pfx) Secret or Certificate object stored in Azure KeyVault. You need to enable soft delete for Key Vault to use this feature. Required if data is not set."', args=[d.arg(name='keyVaultSecretId', type=d.T.string)]),
      ...
      trustedRootCertificate: {
        ...
        '#withKeyVaultSecretId':: d.fn(help='"The Secret ID of the (base-64 encoded unencrypted pfx) Secret or Certificate object stored in Azure KeyVault. You need to enable soft delete for the Key Vault to use this feature. Required if data is not set."', args=[d.arg(name='keyVaultSecretId', type=d.T.string)]),
        withKeyVaultSecretId(keyVaultSecretId): { keyVaultSecretId: keyVaultSecretId },
      ...
      wafConfiguration: {
        ...
        '#withRuleSetVersion':: d.fn(help='"The Version of the Rule Set used for this Web Application Firewall. Possible values are 0.1, 1.0, 1.1, 2.1, 2.2.9, 3.0, 3.1 and 3.2."', args=[d.arg(name='ruleSetVersion', type=d.T.string)]),
      ...
      '#withRewriteRuleSet':: d.fn(help='"One or more rewrite_rule_set blocks as defined below. Only valid for v2 WAF and Standard SKUs."', args=[d.arg(name='rewriteRuleSet', type=d.T.array)]),
      ...
      '#withRewriteRuleSetMixin':: d.fn(help='"One or more rewrite_rule_set blocks as defined below. Only valid for v2 WAF and Standard SKUs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rewriteRuleSet', type=d.T.array)]),
