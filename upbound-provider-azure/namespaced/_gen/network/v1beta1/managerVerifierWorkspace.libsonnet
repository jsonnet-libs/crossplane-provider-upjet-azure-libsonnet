{
  ...
  '#':: d.pkg(name='managerVerifierWorkspace', url='', help='"ManagerVerifierWorkspace is the Schema for the ManagerVerifierWorkspaces API. Manages a Network Manager Verifier Workspace."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagerVerifierWorkspace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'network.azure.m.upbound.io/v1beta1',
    kind: 'ManagerVerifierWorkspace',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ManagerVerifierWorkspaceSpec defines the desired state of ManagerVerifierWorkspace"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The Description of the Network Manager Verifier Workspace."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Network Manager Verifier Workspace should exist. Changing this forces a new Network Manager Verifier Workspace to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withNetworkManagerId':: d.fn(help='"The ID of the Network Manager. Changing this forces a new Network Manager Verifier Workspace to be created."', args=[d.arg(name='networkManagerId', type=d.T.string)]),
      withNetworkManagerId(networkManagerId): { spec+: { forProvider+: { networkManagerId: networkManagerId } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Network Manager Verifier Workspace."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Network Manager Verifier Workspace."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
