{
  ...
  new(name): {
    apiVersion: 'iotcentral.azure.m.upbound.io/v1beta1',
    kind: 'Application',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTemplate':: d.fn(help='"A template name. IoT Central application template name. Defaults to iotc-pnp-preview@1.0.0. Changing this forces a new resource to be created."', args=[d.arg(name='template', type=d.T.string)]),
