{
  ...
  '#':: d.pkg(name='group', url='', help='"Group is the Schema for the Groups API. Manages an API Management Group."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiManagementName':: d.fn(help='"The name of the API Management Service in which the API Management Group should exist. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withDescription':: d.fn(help='"The description of this API Management Group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name of this API Management Group."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withExternalId':: d.fn(help='"The identifier of the external Group. For example, an Azure Active Directory group aad://<tenant id>/groups/<group object id>. Changing this forces a new resource to be created."', args=[d.arg(name='externalId', type=d.T.string)]),
      withExternalId(externalId): { spec+: { forProvider+: { externalId: externalId } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the API Management Group should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withType':: d.fn(help='"The type of this API Management Group. Possible values are custom, external and system. Default is custom. Changing this forces a new resource to be created."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withExternalId':: d.fn(help='"The identifier of the external Group. For example, an Azure Active Directory group aad://<tenant id>/groups/<group object id>. Changing this forces a new resource to be created."', args=[d.arg(name='externalId', type=d.T.string)]),
      withExternalId(externalId): { spec+: { initProvider+: { externalId: externalId } } },
      '#withType':: d.fn(help='"The type of this API Management Group. Possible values are custom, external and system. Default is custom. Changing this forces a new resource to be created."', args=[d.arg(name='type', type=d.T.string)]),
