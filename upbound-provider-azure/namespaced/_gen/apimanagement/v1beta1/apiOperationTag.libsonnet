  ...
  spec: {
    ...
    forProvider: {
      ...
      apiOperationIdRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { apiOperationIdRef+: { namespace: namespace } } } },
      },
      ...
      apiOperationIdSelector: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { apiOperationIdSelector+: { namespace: namespace } } } },
      },
