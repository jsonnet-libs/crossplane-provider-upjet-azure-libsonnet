{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withParameters':: d.fn(help='"Parameters for the policy definition. This field is a JSON string that allows you to parameterize your policy definition. Reducing the number of parameters forces a new resource to be created."', args=[d.arg(name='parameters', type=d.T.string)]),
