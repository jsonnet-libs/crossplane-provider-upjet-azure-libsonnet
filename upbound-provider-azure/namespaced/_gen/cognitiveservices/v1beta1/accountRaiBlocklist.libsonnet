{
  ...
  '#':: d.pkg(name='accountRaiBlocklist', url='', help='"AccountRaiBlocklist is the Schema for the AccountRaiBlocklists API. Manages a Cognitive Account Rai Blocklist."'),
  ...
  '#new':: d.fn(help='new returns an instance of AccountRaiBlocklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cognitiveservices.azure.m.upbound.io/v1beta1',
    kind: 'AccountRaiBlocklist',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AccountRaiBlocklistSpec defines the desired state of AccountRaiBlocklist"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCognitiveAccountId':: d.fn(help='"The ID of the Cognitive Services Account. Changing this forces a new Cognitive Account Rai Blocklist to be created."', args=[d.arg(name='cognitiveAccountId', type=d.T.string)]),
      withCognitiveAccountId(cognitiveAccountId): { spec+: { forProvider+: { cognitiveAccountId: cognitiveAccountId } } },
      '#withDescription':: d.fn(help='"A short description for the Cognitive Account Rai Blocklist."', args=[d.arg(name='description', type=d.T.string)]),
