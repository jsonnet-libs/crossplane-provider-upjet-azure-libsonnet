{
  ...
  new(name): {
    apiVersion: 'azurestackhci.azure.m.upbound.io/v1beta1',
    kind: 'Cluster',
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on the Azure Stack HCI Cluster. Possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withClientId':: d.fn(help='"The Client ID of the Azure Active Directory Application which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created."', args=[d.arg(name='clientId', type=d.T.string)]),
