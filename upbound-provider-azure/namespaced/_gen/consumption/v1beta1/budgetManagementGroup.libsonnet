  ...
  spec: {
    ...
    forProvider: {
      ...
      filter: {
        ...
        dimension: {
          '#valuesRefs':: d.obj(help='"References to ResourceGroup in azure to populate values."'),
          valuesRefs: {
          ...
          '#valuesSelector':: d.obj(help='"Selector for a list of ResourceGroup in azure to populate values."'),
          valuesSelector: {
          ...
          '#withValuesRefs':: d.fn(help='"References to ResourceGroup in azure to populate values."', args=[d.arg(name='valuesRefs', type=d.T.array)]),
          withValuesRefs(valuesRefs): { valuesRefs: if std.isArray(v=valuesRefs) then valuesRefs else [valuesRefs] },
          '#withValuesRefsMixin':: d.fn(help='"References to ResourceGroup in azure to populate values."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='valuesRefs', type=d.T.array)]),
