{
  ...
  new(name): {
    apiVersion: 'notificationhubs.azure.m.upbound.io/v1beta1',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnabled':: d.fn(help='"Is this Notification Hub Namespace enabled? Defaults to true. Changing this forces a new resource to be created."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withNamespaceType':: d.fn(help='"The Type of Namespace - possible values are Messaging or NotificationHub. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceType', type=d.T.string)]),
      withNamespaceType(namespaceType): { spec+: { forProvider+: { namespaceType: namespaceType } } },
      '#withReplicationRegion':: d.fn(help='"The allowed Replication Region for the Notification Hub Namespace. Possible values are Default, None, AustraliaEast, BrazilSouth, NorthEurope, SouthAfricaNorth, SouthEastAsia, WestUs2. Changing this forces a new resource to be created. Defaults to Default."', args=[d.arg(name='replicationRegion', type=d.T.string)]),
      withReplicationRegion(replicationRegion): { spec+: { forProvider+: { replicationRegion: replicationRegion } } },
      ...
      '#withZoneRedundancyEnabled':: d.fn(help='"Is Zone Redundancy Enabled for the Notification Hub Namespace. Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='zoneRedundancyEnabled', type=d.T.boolean)]),
    ...
    initProvider: {
      ...
      '#withReplicationRegion':: d.fn(help='"The allowed Replication Region for the Notification Hub Namespace. Possible values are Default, None, AustraliaEast, BrazilSouth, NorthEurope, SouthAfricaNorth, SouthEastAsia, WestUs2. Changing this forces a new resource to be created. Defaults to Default."', args=[d.arg(name='replicationRegion', type=d.T.string)]),
      withReplicationRegion(replicationRegion): { spec+: { initProvider+: { replicationRegion: replicationRegion } } },
      '#withSkuName':: d.fn(help='"The name of the SKU to use for this Notification Hub Namespace. Possible values are Free, Basic or Standard."', args=[d.arg(name='skuName', type=d.T.string)]),
