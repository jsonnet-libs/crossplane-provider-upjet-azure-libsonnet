{
  ...
  new(name): {
    apiVersion: 'loadtestservice.azure.m.upbound.io/v1beta1',
    kind: 'LoadTest',
  ...
  spec: {
    ...
    forProvider: {
      '#encryption':: d.obj(help='"An encryption block as defined below. Changing this forces a new Load Test to be created."'),
      encryption: {
        '#identity':: d.obj(help='"An identity block as defined below. Changing this forces a new Load Test to be created."'),
        identity: {
          '#withIdentityId':: d.fn(help='"The User Assigned Identity ID that should be assigned to this Load Test Encryption. Changing this forces a new Load Test to be created."', args=[d.arg(name='identityId', type=d.T.string)]),
          withIdentityId(identityId): { spec+: { forProvider+: { encryption+: { identity+: { identityId: identityId } } } } },
          ...
          withType(type): { spec+: { forProvider+: { encryption+: { identity+: { type: type } } } } },
        },
        '#withKeyUrl':: d.fn(help='"The URI specifying the Key vault and key to be used to encrypt data in this resource. The URI should include the key version. Changing this forces a new Load Test to be created."', args=[d.arg(name='keyUrl', type=d.T.string)]),
        withKeyUrl(keyUrl): { spec+: { forProvider+: { encryption+: { keyUrl: keyUrl } } } },
      },
      ...
      '#withDescription':: d.fn(help='"Description of the resource."', args=[d.arg(name='description', type=d.T.string)]),
    ...
    initProvider: {
      ...
      encryption: {
        ...
        identity: {
          '#withIdentityId':: d.fn(help='"The User Assigned Identity ID that should be assigned to this Load Test Encryption. Changing this forces a new Load Test to be created."', args=[d.arg(name='identityId', type=d.T.string)]),
          withIdentityId(identityId): { spec+: { initProvider+: { encryption+: { identity+: { identityId: identityId } } } } },
          '#withType':: d.fn(help='"Specifies the type of Managed Identity that should be assigned to this Load Test. Possible values are SystemAssigned, SystemAssigned, UserAssigned and UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { initProvider+: { encryption+: { identity+: { type: type } } } } },
        },
        '#withKeyUrl':: d.fn(help='"The URI specifying the Key vault and key to be used to encrypt data in this resource. The URI should include the key version. Changing this forces a new Load Test to be created."', args=[d.arg(name='keyUrl', type=d.T.string)]),
        withKeyUrl(keyUrl): { spec+: { initProvider+: { encryption+: { keyUrl: keyUrl } } } },
      },
      '#identity':: d.obj(help='"An identity block as defined below. Specifies the Managed Identity which should be assigned to this Load Test."'),
      identity: {
        '#withIdentityIds':: d.fn(help='"A list of the User Assigned Identity IDs that should be assigned to this Load Test."', args=[d.arg(name='identityIds', type=d.T.array)]),
