{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRole':: d.fn(help='"The cluster role assigned to the principal. Valid values include AllDatabasesAdmin, AllDatabasesViewer, and AllDatabasesMonitor. Changing this forces a new resource to be created."', args=[d.arg(name='role', type=d.T.string)]),
