{
  ...
  '#':: d.pkg(name='monitorWorkspace', url='', help='"MonitorWorkspace is the Schema for the MonitorWorkspaces API. Manages an Azure Monitor Workspace."'),
  ...
  '#new':: d.fn(help='new returns an instance of MonitorWorkspace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'insights.azure.m.upbound.io/v1beta1',
    kind: 'MonitorWorkspace',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"MonitorWorkspaceSpec defines the desired state of MonitorWorkspace"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"Specifies the Azure Region where the Azure Monitor Workspace should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Is public network access enabled? Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group where the Azure Monitor Workspace should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Azure Monitor Workspace."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Azure Monitor Workspace."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
