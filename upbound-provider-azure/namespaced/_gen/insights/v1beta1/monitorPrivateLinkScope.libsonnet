{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIngestionAccessMode':: d.fn(help='"The default ingestion access mode for the associated private endpoints in scope. Possible values are Open and PrivateOnly. Defaults to Open."', args=[d.arg(name='ingestionAccessMode', type=d.T.string)]),
      withIngestionAccessMode(ingestionAccessMode): { spec+: { forProvider+: { ingestionAccessMode: ingestionAccessMode } } },
      '#withQueryAccessMode':: d.fn(help='"The default query access mode for hte associated private endpoints in scope. Possible values are Open and PrivateOnly. Defaults to Open."', args=[d.arg(name='queryAccessMode', type=d.T.string)]),
      withQueryAccessMode(queryAccessMode): { spec+: { forProvider+: { queryAccessMode: queryAccessMode } } },
    ...
    initProvider: {
      '#withIngestionAccessMode':: d.fn(help='"The default ingestion access mode for the associated private endpoints in scope. Possible values are Open and PrivateOnly. Defaults to Open."', args=[d.arg(name='ingestionAccessMode', type=d.T.string)]),
      withIngestionAccessMode(ingestionAccessMode): { spec+: { initProvider+: { ingestionAccessMode: ingestionAccessMode } } },
      '#withQueryAccessMode':: d.fn(help='"The default query access mode for hte associated private endpoints in scope. Possible values are Open and PrivateOnly. Defaults to Open."', args=[d.arg(name='queryAccessMode', type=d.T.string)]),
      withQueryAccessMode(queryAccessMode): { spec+: { initProvider+: { queryAccessMode: queryAccessMode } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Azure Monitor Private Link Scope."', args=[d.arg(name='tags', type=d.T.object)]),
