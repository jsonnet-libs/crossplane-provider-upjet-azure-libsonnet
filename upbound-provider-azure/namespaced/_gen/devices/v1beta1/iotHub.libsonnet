{
  ...
  new(name): {
    apiVersion: 'devices.azure.m.upbound.io/v1beta1',
    kind: 'IOTHub',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventHubPartitionCount':: d.fn(help='"The number of device-to-cloud partitions used by backing event hubs. Must be between 2 and 128. Defaults to 4."', args=[d.arg(name='eventHubPartitionCount', type=d.T.number)]),
      withEventHubPartitionCount(eventHubPartitionCount): { spec+: { forProvider+: { eventHubPartitionCount: eventHubPartitionCount } } },
      '#withEventHubRetentionInDays':: d.fn(help='"The event hub retention to use in days. Must be between 1 and 7. Defaults to 1."', args=[d.arg(name='eventHubRetentionInDays', type=d.T.number)]),
