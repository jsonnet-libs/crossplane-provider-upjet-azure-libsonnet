{
  ...
  '#':: d.pkg(name='workspaceOutboundRuleFqdn', url='', help='"WorkspaceOutboundRuleFqdn is the Schema for the WorkspaceOutboundRuleFqdns API. Manages an Azure Machine Learning Workspace FQDN Network Outbound Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkspaceOutboundRuleFqdn', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'machinelearningservices.azure.upbound.io/v1beta1',
    kind: 'WorkspaceOutboundRuleFqdn',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'false',
  }),
  '#spec':: d.obj(help='"WorkspaceOutboundRuleFqdnSpec defines the desired state of WorkspaceOutboundRuleFqdn"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDestinationFqdn':: d.fn(help='"Specifies the fully qualified domain name to allow for outbound traffic."', args=[d.arg(name='destinationFqdn', type=d.T.string)]),
      withDestinationFqdn(destinationFqdn): { spec+: { forProvider+: { destinationFqdn: destinationFqdn } } },
    ...
    initProvider: {
      '#withDestinationFqdn':: d.fn(help='"Specifies the fully qualified domain name to allow for outbound traffic."', args=[d.arg(name='destinationFqdn', type=d.T.string)]),
      withDestinationFqdn(destinationFqdn): { spec+: { initProvider+: { destinationFqdn: destinationFqdn } } },
    },
