  ...
  spec: {
    ...
    initProvider: {
      ...
      encryption: {
        ...
        '#withIdentity':: d.fn(help='"An identity block as defined below. Changing this forces a new Load Test to be created."', args=[d.arg(name='identity', type=d.T.array)]),
        withIdentity(identity): { identity: if std.isArray(v=identity) then identity else [identity] },
        '#withIdentityMixin':: d.fn(help='"An identity block as defined below. Changing this forces a new Load Test to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identity', type=d.T.array)]),
        withIdentityMixin(identity): { identity+: if std.isArray(v=identity) then identity else [identity] },
        '#withKeyUrl':: d.fn(help='"The URI specifying the Key vault and key to be used to encrypt data in this resource. The URI should include the key version. Changing this forces a new Load Test to be created."', args=[d.arg(name='keyUrl', type=d.T.string)]),
      ...
      '#withEncryption':: d.fn(help='"An encryption block as defined below. Changing this forces a new Load Test to be created."', args=[d.arg(name='encryption', type=d.T.array)]),
      withEncryption(encryption): { spec+: { initProvider+: { encryption: if std.isArray(v=encryption) then encryption else [encryption] } } },
      '#withEncryptionMixin':: d.fn(help='"An encryption block as defined below. Changing this forces a new Load Test to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryption', type=d.T.array)]),
