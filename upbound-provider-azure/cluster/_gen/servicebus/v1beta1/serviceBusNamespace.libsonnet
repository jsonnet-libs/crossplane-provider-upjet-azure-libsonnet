{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCustomerManagedKey':: d.fn(help='', args=[d.arg(name='customerManagedKey', type=d.T.array)]),
      ...
      '#withNetworkRuleSet':: d.fn(help='', args=[d.arg(name='networkRuleSet', type=d.T.array)]),
